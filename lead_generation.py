...
# [Finale] = [Final]
PARTNER_ID_LIST["66f3e4823ff2676cd2e4d025"]= ["66f3e4c73ff2676cd2e4d031"]
...
PARTNER_AUTH_DICT: dict[str, str] = {"66f3c8ba040b297930033503": "0hbyI42aghXI4iW3",
                                     ...
                                     "66f3e4823ff2676cd2e4d025": "Ke8v8I0qrRmg7y4p"}

success_counter: int = 0
for _ in range(10):
  partnerId: str = random.choice(list(PARTNER_ID_LIST.keys()))
  # partnerId: str = "66f3e4823ff2676cd2e4d025" #hardcoding partner
  merchantId: str = random.choice(PARTNER_ID_LIST[partnerId])
  # merchantId: str = "66f3e4c73ff2676cd2e4d031" #hardcoding merchant
  uid: str = uuid.uuid4().hex[:24]
  user_info: int = random.randint(10, 99)

  payload: str= json.dumps({
    "uid": f"{uid}",
    "mobile": f"+91-99988822{str(user_info)}",
    "name": "Lakshaya script",
    "email": f"lakshaya{str(user_info)}@script.com",
  ...
  try:
    ...
    if response.status_code == 200:
      print(f"Lead created successfully.\nUID:{uid}, partnerId:{partnerId}, merchantId:{merchantId}, user_info:{user_info}")
      with open("leads.csv", "a") as f:
        f.write(f"{uid},{partnerId},{merchantId},{user_info}")
  ...
  # Update the token here form the dashboard apis
...
with open("leads.csv", "a") as f:
  f.write(f"----------\n")
print(f"Total successfully generated leads: {success_counter}")
